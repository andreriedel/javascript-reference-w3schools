/**
 * o método some verifica se no mínimo um elemento de um array é válido em uma
 * determinada função e retorna um valor booleano
 *
 * o método some recebe 2 parâmetros:
 *
...
const ages = [16, 33, 17, 40];

console.log("Resultado: ", ages.some(olderThan, 18));
