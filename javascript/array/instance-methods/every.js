/**
 * o método every verifica se todos os elementos de um array são válidos em uma
 * determinada função e retorna um valor booleano
 *
 * o método every recebe 2 parâmetros:
 *
...
console.log("Resultado: ", ages.every(olderThan, 18));
