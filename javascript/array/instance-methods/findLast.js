 ...
 * 
 * o método findLast verifica se os elementos de um array são válidos em uma
 * determinada função e retorna o primeiro desses elementos; a verificação é
 * feita da direita para a esquerda
 *
 * o método findLast recebe 2 parâmetros:
 *
...
const olderThan18 = ages.findLast(olderThan, 18);

console.log("Resultado: ", olderThan18);
